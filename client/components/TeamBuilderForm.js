  ...
  render(){
    ...
    return(
      <div className="team-builder-form" id={this.props.team}>
        ...
        <p className="player-list-title">All Team Members Of {this.props.team} Team</p>
        ...
        <p className="team-member-amount">Total of {this.state.participants.length} players in {this.props.team} Team.</p>
